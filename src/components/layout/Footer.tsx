...
export default function Footer() {
  ...
  // Do not render storefront footer on admin backoffice routes or standalone ticket verification passes
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-white/10">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <p className="text-sm text-gray-400 max-w-md leading-relaxed">
              No Limit Fest is a global music, art, and urban culture spectacle
              curating the world’s most iconic talents across Afrobeats,
              Hip-Hop, Electronic, Amapiano, and Latin sounds. Elevating live
              entertainment with boundary-pushing stage architecture and luxury
              hospitality.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li>
                <Link
                  href="/#tickets"
                  className="text-[#FF6E40] font-semibold hover:text-[#FF5722] transition-colors"
                >
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8 text-center lg:text-left">
              ...
              <div className="space-y-1.5 max-w-md">
                ...
                <p className="text-xs sm:text-sm text-gray-400 leading-relaxed">
                  No Limit Fest is proudly presented by{" "}
                  <strong className="text-[#FFD600]">Shurlaybor Empire</strong>{" "}
                  and{" "}
                  <strong className="text-emerald-400">Typical Naija</strong>,
                  hosted live at{" "}
                  <strong className="text-[#E08A3E]">
