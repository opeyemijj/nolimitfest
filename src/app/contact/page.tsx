...
export const metadata: Metadata = {
  title:
    "Contact Organizers (Shurlaybor & Typical Naija) & Concierge | No Limit Fest",
  description:
  ...
  openGraph: {
    ...
    description:
      "Connect directly with Shurlaybor Empire and Typical Naija for sponsorships, press, and table inquiries.",
      ...
      <div className="relative py-20 px-4 sm:px-6 lg:px-8 border-b border-white/10 overflow-hidden">
        <div className="max-w-5xl mx-auto text-center relative z-10 space-y-4">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto text-sm sm:text-base leading-relaxed">
            Partner with the world’s most exciting emerging music and culture
            festival. Reach our executive team in Dubai.
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-8 rounded-3xl bg-[#11131E] border border-white/10 space-y-4">
            ...
            <p className="text-xs text-gray-400 leading-relaxed">
              Explore bespoke stage naming rights, experiential activation
              pavilions, VIP gifting lounges, and high-impact digital
              impressions across 65,000+ festivalgoers.
            </p>
            <a
          ...
          <div className="p-8 rounded-3xl bg-[#11131E] border border-white/10 space-y-4">
            ...
            <p className="text-xs text-gray-400 leading-relaxed">
              Accreditation for international journalists, broadcast networks,
              music editors, and photojournalists opens 60 days before the
              festival.
            </p>
            <a
          ...
          <div className="p-8 rounded-3xl bg-[#11131E] border border-white/10 space-y-4">
            ...
            <p className="text-xs text-gray-400 leading-relaxed">
              Emerging DJs, vocalists, and live performers across Afrobeats,
              Hip-Hop, EDM, and Amapiano can submit EPKs and live festival
              footage for consideration.
            </p>
            <a
        ...
        <div className="p-8 sm:p-12 rounded-3xl bg-gradient-to-r from-[#17231E] via-[#121A1A] to-[#11131E] border border-emerald-500/30 flex flex-col md:flex-row items-center justify-between gap-6 shadow-2xl">
          <div className="space-y-2 text-center md:text-left">
            ...
            <p className="text-xs sm:text-sm text-gray-300 max-w-xl">
              For rapid response regarding high-priority table bookings, VIP
              concierge, and international group hospitality packages.
            </p>
          </div>
      ...
      <div className="py-20 px-4 sm:px-6 lg:px-8 bg-[#0D0F1A] border-t border-white/10 text-center relative overflow-hidden">
        <div className="max-w-3xl mx-auto space-y-6 relative z-10">
          ...
          <h2 className="text-3xl sm:text-5xl font-black uppercase text-white tracking-tight">
            JOIN US LIVE IN DUBAI
          </h2>
          <p className="text-sm sm:text-base text-gray-300 max-w-xl mx-auto">
            Headliner RUGER Live at Helipad by Frozen Cherry. Saturday 24th
            October 2026. Secure your pass today.
          </p>
          <div className="pt-2">
            <Link
              href="/#tickets"
            ...
            >
              <span>Buy Passes &amp; VIP Tables</span>
            </Link>
          </div>
        </div>
      </div>
